...
namespace GoogleARCore.Examples.AugmentedImage
{
    ...
    public class AugmentedImageVisualizer : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            /*FrameLowerLeft.transform.LookAt(targ.transform);
            FrameLowerRight.transform.LookAt(targ.transform);
            FrameUpperLeft.transform.LookAt(targ.transform);
            FrameUpperRight.transform.LookAt(targ.transform);*/
        }
    }
}
